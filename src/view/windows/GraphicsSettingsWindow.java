...
public class GraphicsSettingsWindow extends SettingsWindow {
    ...
    private JPanel createPenPanel() {
        ...
        penPanel.setBorder(BorderFactory.createTitledBorder(
                   BorderFactory.createEtchedBorder(), "Pen Properties"));
        return penPanel;
    }
    ...
    private JPanel createGridPanel() {
        ...
        gridPanel.setBorder(BorderFactory.createTitledBorder(
                   BorderFactory.createEtchedBorder(), "Grid Settings"));
        return gridPanel;
    }
    ...
    protected void addOkButtonListener () {
        myOkButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed (ActionEvent e) {
                ...
                //TODO implement in the most effective way raising and lowering the pen from active turtles. Waiting until model finds a solution
            ...
            private void checkGridPanel() {
                if (myEnableGridBox.isSelected()) {
                    ...
                    try {
                        myWorkspace.getCanvas().setGridSpacing(Integer.parseInt(mySpacingField.getText()));
                    }
                    catch (Exception ex) {
